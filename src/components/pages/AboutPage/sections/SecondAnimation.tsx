...
const photos = [
  "/details/nilanjan/1.JPEG",
  "/details/nilanjan/7.jpg",
  "/details/nilanjan/3.jpg",
  "/details/nilanjan/8.jpg",
  "/details/nilanjan/5.jpg",
  "/details/nilanjan/6.jpg",
];
        ...
        <div className="reveal-on-scroll p-6 bg-white/70 backdrop-blur-md rounded-xl shadow-sm flex flex-col justify-center">
          <div className="space-y-6">
            ...
            <div className="space-y-3 md:flex md:items-center md:justify-between">
              ...
              <Link
                href={
                  "https://www.instagram.com/dnilan_24?igsh=MWtsZHdjd2o5bnVvaQ=="
                }
                target="_blank"
              >
